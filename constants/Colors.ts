export const Colors = {
  ...
  //   success: "rgb(0, 108, 73)",
  //   onSuccess: "rgb(255, 255, 255)",
  //   successContainer: "rgb(139, 247, 195)",
  //   onSuccessContainer: "rgb(0, 33, 19)",
  //   warning: "rgb(134, 83, 0)",
  //   onWarning: "rgb(255, 255, 255)",
  //   warningContainer: "rgb(255, 221, 185)",
  //   onWarningContainer: "rgb(43, 23, 0)",
  //   info: "rgb(0, 104, 119)",
  //   onInfo: "rgb(255, 255, 255)",
  //   infoContainer: "rgb(163, 238, 255)",
  //   onInfoContainer: "rgb(0, 31, 37)",
  // },
  // dark: {
  ...
  //   backdrop: "rgba(41, 50, 48, 0.4)",
  //   success: "rgb(111, 219, 169)",
  //   onSuccess: "rgb(0, 56, 36)",
  //   successContainer: "rgb(0, 82, 54)",
  //   onSuccessContainer: "rgb(139, 247, 195)",
  ...
  //   info: "rgb(82, 215, 240)",
  //   onInfo: "rgb(0, 54, 62)",
  //   infoContainer: "rgb(0, 78, 90)",
  //   onInfoContainer: "rgb(163, 238, 255)",
  // },
  light: {
